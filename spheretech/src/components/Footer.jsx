      ...
      <div className="row">
        <div className="col-lg-4 col-md-6 mb-4">
          ...
          <ul className="list-unstyled">
            <li><i className="fas fa-phone"></i> (81) 1234-5678</li>
            <li><i className="fab fa-whatsapp"></i> (81) 91234-5678</li>
            <li>
        ...
        <div className="col-lg-4 col-md-12 mb-4">
          ...
          <i className="fas fa-credit-card"></i> <i className="fas fa-barcode"></i> <i className="fas fa-university"></i>
        </div>
      </div>
    </div>
