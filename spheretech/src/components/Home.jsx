...
import video from '../assets/spheretech.mp4'; 
...
const Home = () => (
  <>
    ...
    <header className='text-center my-5'>
      <img src={logo} alt='Logo da Empresa' className='mb-3' style={{ width: '200px', height: 'auto' }}/>
      ...
      <section className='layout-video'>
        <div>
          ...
          <p>
            ...
            tecnológicos complexos e a transformar suas operações para um futuro
            digital.
          </p>
          <p>
            <strong>
      ...
      <section className='my-5'>
        ...
        <section className='founder-cards'>
          <div className='founder-card'>
            <img src={founder1} alt='Fundador 1' />
            <h4>João Santos</h4>
            <h5>CTO</h5>
            <p>
          ...
          <div className='founder-card'>
            <img src={founder2} alt='Fundador 2' />
            <h4>Mário Silva</h4>
            <h5>CEO</h5>
            <p>
          ...
          <div className='founder-card'>
            <img src={founder3} alt='Fundador 3' />
